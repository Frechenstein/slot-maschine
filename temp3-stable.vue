    ...
    methods: {
      ...
      checkWin() {
        ...
        for (let lineIndex in this.lines) {
          ...
          // Filtere die Symbole, ignoriere Sterne
          const nonStarSymbols = symbolsInLine.filter((symbol) => symbol !== "⭐");
  
          // Wenn alle Nicht-Sterne-Symbole gleich sind oder keine existieren, ist es ein Gewinn
          const isWin =
            nonStarSymbols.length > 0 &&
            nonStarSymbols.every((symbol) => symbol === nonStarSymbols[0]) &&
